  ...
  return (
    <div className={`d-flex justify-content-center align-items-center ${styles.container}`}>
      <div className={`card p-5 ${styles.card}`}>
        ...
        <h3 className="text-center fw-semibold mb-3">Forgot Password</h3>
        ...
        <form noValidate className={`needs-validation ${validated ? "was-validated" : ""}`} onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <input type="password" className="form-control form-control-lg" placeholder="Enter current password" required 
          ...
          <div className="mb-4">
            ...
            <input type="password" className="form-control form-control-lg" placeholder="Enter new password" required 
