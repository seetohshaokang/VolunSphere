      ...
      >
        <DialogContent className="sm:max-w-md bg-white">
          <DialogHeader>
            ...
            <DialogDescription>
              <p className="mb-4">
                Please provide a reason for reporting this event. Our team will
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              >
                ...
                <option value="Event doesn't exist">Event doesn't exist</option>
              ...
              <div className="flex flex-col space-y-4">
                <div>
                  ...
                  <div className="mt-2 grid grid-cols-2 gap-2">
                    ...
                    <span className="font-medium">
                      {organizerData?.phone || "Not provided"}
                    </span>
