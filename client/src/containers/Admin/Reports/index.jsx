...
const AdminReports = () => {
  ...
  const getReportedTypeBadge = (type) => {
    switch(type) {
      ...
      case 'Organiser':
        return <span className="px-2 py-1 text-xs rounded-full bg-purple-100 text-purple-800">Organiser</span>;
      case 'Event':
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="reported_type">
              Reported Type
            </label>
            <select
              id="reported_type"
                ...
                reports.map((report) => (
                  <tr key={report._id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div>
                        <div className="text-sm font-medium text-gray-900">
                          {getReportedTypeBadge(report.reported_type)}
                        </div>
                        <div className="text-sm text-gray-500">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      {report.reason.substring(0, 30)}{report.reason.length > 30 ? '...' : ''}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
