...
async function seedTestData() {
  try {
    ...
    const sampleNricPath = path.join(__dirname, "sample-docs/sample-nric.jpg");
    ...
    if (fs.existsSync(sampleNricPath)) {
      ...
      console.log(
        ` Sample NRIC not found at ${sampleNricPath}, will use placeholder data`
      );
    }
    ...
    if (fs.existsSync(sampleCertPath)) {
      ...
      console.log(
        ` Sample certificate not found at ${sampleCertPath}, will use placeholder data`
      );
    }
    ...
    const volunteer = new Volunteer({
      ...
      nric_image: {
        filename: nricFileExists ? nricFilename : "seeded-test-nric.jpg",
    ...
    const organiser = new Organiser({
      ...
      certification_document: {
        filename: certFileExists ? certFilename : "seeded-test-certificate.jpg",
    ...
    const events = [
      {
        ...
        locationUrl: "https://maps.google.com/?q=Changi+Beach+Park,Singapore",
        causes: ["environment"],
        latitude: 1.3913,
        longitutde: 103.9905,
        max_volunteers: 20,
        ...
        contact_email: "youthnetwork@gmail.com",
        status: "active",
        is_recurring: false,
      ...
      },
      {
        ...
        locationUrl: "https://maps.google.com/?q=National+Library+Singapore",
        latitude: 1.2976,
        longitude: 103.8543,
        causes: ["education"],
        max_volunteers: 10,
      ...
      },
      {
        ...
        location: "150 Pandan Gardens, Singapore 609335",
        locationUrl: "https://maps.google.com/?q=Ayer+Rajah+Community+Club",
        latitude: 1.42749277602918,
        longitude: 103.792240772323,
    ...
    const pastRegistration = new EventRegistration({
      ...
      feedback: {
        from_organiser: {
          ...
          rating: 5,
          submitted_at: new Date(Date.now() - 29 * 24 * 60 * 60 * 1000), // 29 days ago
        },
      },
    });
